...
class Foreground extends StatefulWidget {
  TextEditingController _inputNominal = TextEditingController();
  TextEditingController _inputKeterangan = TextEditingController();
              ...
              child: Column(children: [
                Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: Color.fromARGB(255, 65, 176, 110),
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        TextFormField(
                          controller: widget._inputNominal,
                        ...
                        TextFormField(
                          controller: widget._inputKeterangan,
                          decoration: InputDecoration(
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (widget.dataModel == null) {
                          await widget.databaseData!.insert({
                            'nominal': int.parse(widget._inputNominal.text),
                            'keterangan': widget._inputKeterangan.text,
                            'tanggal':
                                DateTime.parse(widget._dateController.text)
                          });
                        }
                      },
                      child: Text(
